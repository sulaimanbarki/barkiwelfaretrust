<template>
  <div class="px-4 sm:px-6 lg:px-8">
    ...
    <div class="flex justify-between items-center mb-6">
      <h1 class="text-3xl font-bold text-gray-800">{{ paymentMethod.name }}</h1>
      ...
      <div class="border-b border-gray-200">
        <dl>
          <div class="bg-gray-50 px-6 py-5 sm:grid sm:grid-cols-3 sm:gap-4">
            <dt class="text-sm font-medium text-gray-500">Payment Method ID</dt>
          ...
          <div class="bg-gray-50 px-6 py-5 sm:grid sm:grid-cols-3 sm:gap-4">
            ...
            <dd class="mt-1 sm:mt-0 sm:col-span-2">
              <span :class="paymentMethod.is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium">
                {{ paymentMethod.is_active ? 'Active' : 'Inactive' }}
              </span>
            </dd>
          </div>
          <div v-if="paymentMethod.deleted_at" class="bg-white px-6 py-5 sm:grid sm:grid-cols-3 sm:gap-4">
            <dt class="text-sm font-medium text-gray-500">Status</dt>
            <dd class="mt-1 sm:mt-0 sm:col-span-2">
