<template>
  <div>
    ...
    <div class="mb-4" v-if="$can('view-report')">
    ...
    <div class="mb-4" v-if="$can('view-donor')">
    ...
    <!-- campaigns -->
    <div class="mb-4" v-if="$can('view-campaign')">
    ...
    <!-- donations -->
    <div class="mb-4" v-if="$can('view-donation')">
    ...
    <!-- beneficiaries -->
    <div class="mb-4" v-if="$can('view-beneficiary')">
    ...
    <!-- programs -->
    <div class="mb-4" v-if="$can('view-program')">
    ...
    <!-- expenses -->
    <div class="mb-4" v-if="$can('view-expense')">
    ...
    <div class="mb-4" v-if="$can('view-role')">
    ...
    <!-- payment-methods -->
    <div class="mb-4" v-if="$can('view-payment-method')">
