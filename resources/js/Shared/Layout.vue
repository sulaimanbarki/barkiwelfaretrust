      ...
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:shrink-0">
          <div class="flex items-center justify-between px-6 py-4 bg-indigo-900 md:shrink-0 md:justify-center md:w-56">
            <Link class="" href="/">
              <logo class="fill-white" width="40" height="" />
            </Link>
          ...
          <div class="md:text-md flex items-center justify-between p-4 w-full text-sm bg-white border-b md:px-12 md:py-0">
            <div class="mr-4 mt-1">{{ auth.application_details.site_name }}</div>
            <dropdown class="mt-1" placement="bottom-end">
              ...
              <template #dropdown>
                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                  ...
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" v-if="$can('edit-role')" href="/users">Manage Users</Link>
